        ...
        <section className="py-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              >
                Ready to transform your productivity or voice workflows? Get in touch with Davie Mwijay.
              </motion.p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              >
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-gray-400 text-lg mb-6">Thank you for reaching out. Davie will review your message and get back to you within 24 hours.</p>
                    <motion.button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <label className="block text-sm text-gray-400 mb-2">Company / Project</label>
                      <input 
                        type="text" 
                        value={formData.company} 
                        onChange={e => setFormData({...formData, company: e.target.value})}
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all" 
                        placeholder="Project title or company (optional)" 
                      />
                    </div>
                    <div>
              ...
              <motion.div 
                ...
                className="space-y-8"
              >
                <Card className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 transition-all">
                ...
                <Card className="p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-white/10 hover:border-white/20 transition-all">
                  <h3 className="text-white font-semibold text-lg mb-4 flex items-center gap-2">
