  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 h-full w-full [mask-image:radial-gradient(50%_50%,white,transparent_85%)] bg-gradient-to-b from-transparent via-blue-500/5 to-transparent" />
      </TimelineContent>
      <TimelineContent
        animationNum={5}
        timelineRef={pricingRef}
